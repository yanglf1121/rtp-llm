...
void hipblasAlgoMap::setAlgo(const hipblasOperation_t   trans_a,
    ...
    hipblasLtAlgoConfig config{trans_a,      trans_b,   m,           n,           k,        A_data_type, lda,
                               stride_a,     B_data_type, ldb,       stride_b,    C_data_type, ldc,      stride_c,
                               compute_type, batch_count, epilogue};
